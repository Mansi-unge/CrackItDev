...
const RecentActivitySection = ({ recentActivity }) => {
  return (
    <section className=" bg-white backdrop-blur  max-h-[300px] sm:max-h-[400px] md:max-h-[274px] overflow-y-auto  border-2 rounded-3xl hover:shadow-xl border-blue-300 p-4 flex flex-col">
      ...
      {recentActivity.length === 0 ? (
        ...
        <ul className="space-y-3 overflow-y-auto flex-1">
          {recentActivity.map((act, index) => (
            <li
              key={index}
              className={`px-4 py-3 border border-blue-200 rounded-xl transition shadow-sm hover:bg-opacity-80 ${act.isCorrect ? "bg-green-50 border-2 border-green-300" : "bg-red-50 border-2 border-red-300"
                }`}
            >
              {act.type === "mcq" ? (
                <div>
...
//   return (
//     <section className=" bg-white backdrop-blur border-b-2 rounded-3xl hover:shadow-xl border-blue-300 p-4 flex flex-col">
