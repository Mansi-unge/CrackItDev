  ...
  return (
    <div className="flex flex-wrap gap-1.5 lg:gap-4">
      {cardData.map(({ label, value, bg, border, tooltip, id }, i) => (
        <div
          key={i}
          className={`lg:min-w-[140px] ${bg} ${border} flex flex-col items-center justify-center border rounded-2xl text-center hover:shadow-lg hover:scale-[1.03] transition-all cursor-default py-2 px-1 lg:px-12 lg:py-5`}
          data-tooltip-id={id}
