...
const QuestionCard = ({
  ...
  return (
    <div id={`question-${id}`} className="p-4 border-b border-gray-200">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
        ...
        <div className="flex flex-row sm:flex-col gap-3 ml-0 sm:ml-6 mt-4 sm:mt-0 items-center">
          <button onClick={() => onBookmark(id)} className="hover:scale-110 transition-transform">
            {isBookmarked ? (
          ...
          <button onClick={() => onShare(id)} className="hover:scale-110 transition-transform">
