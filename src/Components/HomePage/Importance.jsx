...
const Importance = () => {
  return (
    <section className="bg-gradient-to-br from-blue-100 via-white to-blue-200 py-14">
      ...
      <div className="max-w-8xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 px-4">
        {ImportanceData.map((item, index) => (
          <div
            ...
            className="bg-white shadow-md rounded-2xl px-4 py-2 flex flex-col hover:shadow-xl transition duration-300"
          >
            <span
              className={`mb-1 w-14 h-14 flex items-center justify-center rounded-full ${item.bgColor} hover:transform hover:scale-200 `}
            >
              {item.icon}
            </span>
